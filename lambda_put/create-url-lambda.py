...
app_url = os.getenv('group1-urlshortener.sctp-sandbox.com')  #Your API Gateway Custom Domain
min_char = int(os.getenv('MIN_CHAR'))  #e.g. 12 (min length of shortid)
max_char = int(os.getenv('MAX_CHAR'))  #e.g. 16 (max length of shortid)
region_aws = os.getenv('ap-southeast-1') #replace our region here
db_tablename = os.getenv('thila_sha_url_shortener') # replace our db name here
